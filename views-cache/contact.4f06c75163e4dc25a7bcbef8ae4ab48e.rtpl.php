          ...
          <div class="box box-primary">          
            <div class="box box-solid">
              <div class="box-header with-border">
                ...
                <h3 class="box-title">Endereço no mapa</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
              ...
              <form method="post" action="#" enctype="multipart/form-data">
                <div class="box-body">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label>Nome:</label>
                      <input type="text" class="form-control" id="plan" name="plan" placeholder="Informe o nome ">
                    </div>
                    <div class="form-group">
                      <label>Função:</label>
                      <input type="text" class="form-control" id="pricing" name="pricing" placeholder="Informe a função">
                    </div>   
                  <div class="form-group">                
                    <label>
                    ...
                    <div id="collapse-facebook" class="panel-collapse collapse">
                      <input type="text" class="form-control" id="link-facebook" name="link-facebook" placeholder="Informe o link da página">                
                    </div>
                  </div>
                  ...
                  <div class="form-group">                
                    ...
                    <div id="collapse-twitter" class="panel-collapse collapse">
                      <input type="text" class="form-control" id="link-twitter" name="link-twitter" placeholder="Informe o link da página">
                    </div>
                  </div>  
                  ...
                  <div class="form-group">                
                    ...
                    <div id="collapse-instagram" class="panel-collapse collapse">
                      <input type="text" class="form-control" id="link-instagram" name="link-instagram" placeholder="Informe o link da página">
                    </div>
                  </div>  
                  <div class="form-group">                
                    <label>
                    ...
                    <div id="collapse-linkedin" class="panel-collapse collapse">
                      <input type="text" class="form-control" id="link-linkedin" name="link-linkedin" placeholder="Informe o link da página">
                    </div>
                  </div>    
                  <div class="form-group">
