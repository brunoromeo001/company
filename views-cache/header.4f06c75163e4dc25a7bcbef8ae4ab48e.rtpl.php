...
<head>
  ...
  <!-- Select2 -->
  <link rel="stylesheet" href="/res/admin/bower_components/select2/dist/css/select2.min.css">
  <!-- Bootstrap Color Picker -->
  <link rel="stylesheet" href="/res/admin/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="/res/admin/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="/res/admin/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="/res/admin/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="/res/admin/bower_components/bootstrap-daterangepicker/daterangepicker.css">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php } ?>
        <?php if( substr_count($pageName, 'about-us') ){ ?>
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="/admin/about-us"><i class="fa fa-circle-o"></i> About us</a></li>
            <li><a href="/admin/team"><i class="fa fa-circle-o"></i> Team</a></li>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="/admin/team"><i class="fa fa-circle-o"></i> Team</a></li>
            <li><a href="/admin/testimonials"><i class="fa fa-circle-o"></i> Testimonials</a></li>            
          </ul>
        </li>
