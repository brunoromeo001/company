    ...
    <section id="skills" class="skills">
      <div class="container">
        ...
        <div class="row skills-content">
          <?php $counter1=-1;  if( isset($skill) && ( is_array($skill) || $skill instanceof Traversable ) && sizeof($skill) ) foreach( $skill as $key1 => $value1 ){ $counter1++; ?>
          <div class="col-lg-6" data-aos="fade-up">
            <div class="progress">
              <span class="skill"><?php echo $value1["name_skill"]; ?> <i class="val"><?php echo $value1["value_skill"]; ?>%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo $value1["value_skill"]; ?>" aria-valuemin="0" aria-valuemax="<?php echo $value1["value_skill"]; ?>"></div>
              </div>
            </div>
          </div>
          <?php } ?>
