<?php if(!class_exists('Rain\Tpl')){exit;}?>  <!-- Content Wrapper. Contains page content -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="/admin/asked-update">
            ...
            <input type="hidden" id="id_asked" name="id_asked" >
          </form>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    scripts.push(function(){
      ...
      $('#modalAskedUpdate').on('show.bs.modal', function (event) {
        var button = $(event.relatedTarget); // Button that triggered the modal
        var id_asked = button.data('id_asked');// Extract info from data-* attributes
        var asked = button.data('asked');
        var answer = button.data('answer');
      
        // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
        // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
        var modal = $(this);
        modal.find('#id_asked').val(id_asked);
        modal.find('#asked').val(asked);
