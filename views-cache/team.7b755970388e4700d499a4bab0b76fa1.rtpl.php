              ...
              <table class="table table-hover">
                <tbody>
                  ...
                  <?php $counter1=-1;  if( isset($teams) && ( is_array($teams) || $teams instanceof Traversable ) && sizeof($teams) ) foreach( $teams as $key1 => $value1 ){ $counter1++; ?>  
                    ...
                    <td>
                      <button type="button" class="btn btn-primary btn-xs view_data" data-toggle="modal" data-target="#modalTeamUpdate" data-id_team="<?php echo $value1["id_team"]; ?>" data-name_team="<?php echo $value1["name_team"]; ?>" data-function_team="<?php echo $value1["function_team"]; ?>">
